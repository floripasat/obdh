...
#define AUX_DATA_STORAGE_BEGIN            0x00007FF9	//< First address where data can be stored in the auxiliary memories;
#define AUX_DATA_STORAGE_END			  0x00FFFFF9	//< Last address where data can be stored inthe auxiliary memories;
#define AUX_NWP_STORAGE_BEGIN			  0x00000000	//< First position dedicated to storing the packet addresses;
#define AUX_NWP_STORAGE_END				  0x00007FF8	//<	Last position dedicated to storing the packet addresses;
